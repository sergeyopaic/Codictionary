...
class _DictionaryBodyState extends State<DictionaryView> {
                            ...
                            children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: WordCardMenu(
                                        onExplain: () => _showWordExplanation(context, vm, i),
                                        onEdit: () => _showAddEditDialog(context, vm, index: i),
                                        onDelete: () async {
                                          final ok = await _confirmDeleteDialog(context, word.eng);
                                          if (ok) await vm.deleteById(word.id);
                                        },
                                      ),
                                    ),
                                  ],
                              ...
                              if (vm.selectionMode)
                                Positioned(
                                  ...
                                  child: Checkbox(
                                    value: isSelected,
                                    onChanged: (_) => vm.toggleSelect(word.id),
                                  ),
                                ),
                            ],
                          ),
  ...
  Future<void> _showAddEditDialog(BuildContext context, DictionaryViewModel vm,
      {int? index}) async {
    final isEdit = index != null;
    final engController = TextEditingController(text: isEdit ? vm.words[index].eng : '');
    final rusController = TextEditingController(text: isEdit ? vm.words[index].rus : '');
  ...
  Future<void> _showWordExplanation(
      BuildContext context, DictionaryViewModel vm, int index) async {
  ...
  Future<bool> _confirmDeleteDialog(BuildContext context, String wordEng) async {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 6),
                          Text('"$wordEng" will be removed from your dictionary.',
