...
class CodeDictionaryTitle extends StatelessWidget {
  const CodeDictionaryTitle({
    ...
    this.strokeWidth =
        3.0, // NРїС—Р…???РїС—Р…NРїС—Р…?????РїС—Р… ???РїС—Р…??????????
    ...
    this.gap =
        8.0, // ??NРїС—Р…N?NРїС—Р…N??? ???РїС—Р…?РїС—Р…??N? ???РїС—Р…N?????NРїС—Р…???? ?? NРїС—Р…?РїС—Р…??N?NРїС—Р…????
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        SizedBox(width: gap),
        // ?РїС—Р…???????????? NРїС—Р…?РїС—Р…??N?NРїС—Р…: ???РїС—Р…?????????РїС—Р… + ?РїС—Р…?РїС—Р…?РїС—Р…???????РїС—Р…
        Stack(
          children: [
            // ?z?РїС—Р…?????????РїС—Р…
            Text(
